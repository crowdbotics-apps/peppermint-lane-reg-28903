...
## Project Structure
    ...
    ├── peppermint_lane_reg_28903  # Django project configurations
...
1. Clone this repo and `cd peppermint_lane_reg_28903`
...
2. Clone this repo and `cd peppermint_lane_reg_28903`
